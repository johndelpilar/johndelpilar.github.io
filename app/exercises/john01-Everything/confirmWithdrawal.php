...
<title>Everything</title>
    ...
    <body>
    	<?php 
	    	...
	    	$totalAmount = $_COOKIE['withdrawAmount'] * 1.02;
	    	
    	?>
    		    	
    	<form action="logout.php">
    		<h3>Amount has been withdrawn!</h3>
    		<h4>Check the details below:</h4>
    		...
    		PIN Number: ****
    		<br>
    		Previous Balance: &#8369; <?php echo $client->getInitialBalance(); ?>
    		<br>
    		<br>
    		Withdraw Amount: &#8369; <?php echo $_COOKIE['withdrawAmount']; ?>   
    		<br>
    		Withdraw Fee: &#8369; <?php echo $_COOKIE['withdrawAmount'] * 0.02; ?>
    		<br>
    		Current Balance: &#8369; <?php echo $client->getInitialBalance() - $totalAmount; ?>
